    ...
    public class DataGenerator
    {
        ...
        public DataGenerator()
        {
            ...
            bogusData = new Faker<BogusData>()
                ...
                .RuleFor(f => f.FullName, (r, f) => f.FirstName + " " + f.LastName)
                ...
                .RuleFor(f => f.StateAbbr, r => r.Address.StateAbbr())
                .RuleFor(f => f.State, r => r.Address.State())
                ...
                .RuleFor(f => f.ExpMonth, r => r.Random.Int(1, 12).ToString("D2"))
                .RuleFor(f => f.ExpYear, r => r.Random.Int(2024, 2037).ToString())
